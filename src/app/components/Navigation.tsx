...
export function Navigation() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay (sibling to nav) */}
      <div
        className={`md:hidden fixed inset-0 bg-black/95 transition-all duration-300 ${
          isMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible'
        } z-50 p-6 overflow-auto`}
      >
        <div className="flex flex-col items-center justify-start min-h-screen gap-8 pt-28">
          <button
            onClick={() => scrollToSection('sobre-mi')}
